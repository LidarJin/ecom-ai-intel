...
// ============================================================================
// Ecommerce AI Intel — Delivery Script
// ============================================================================
// Sends a digest to the user via their chosen delivery method.
// Supports: Telegram bot, Email (via Resend), Slack MCP, or stdout (default).
//
// Usage:
...
async function sendEmail(text, apiKey, toEmail) {
  const res = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      from: 'Ecommerce AI Intel <digest@resend.dev>',
      to: [toEmail],
      subject: `Ecommerce AI Intel — Week of ${new Date().toLocaleDateString('en-US', {
